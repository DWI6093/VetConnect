...
export class NegociosServicio {
  ...
  public obtenerDetalleColaborador(idNegocio: number): Observable<NegocioDetalleColaborador> {
    return this.httpCliente.get<NegocioDetalleColaborador>(
      `${this.urlBaseApi}/negocios/colaborador/${idNegocio}`,
      {
        withCredentials: true,
      },
    );
  ...
  public actualizarNegocio(
    idNegocio: number,
    datos: ActualizarNegocioPayload,
  ): Observable<NegocioColaborador> {
    return this.httpCliente.patch<NegocioColaborador>(
      `${this.urlBaseApi}/negocios/${idNegocio}`,
      datos,
      {
        withCredentials: true,
      },
  ...
  public cambiarEstadoNegocio(
    idNegocio: number,
    estado: 'ACTIVO' | 'INACTIVO',
  ): Observable<{ id_negocio: number; estado: string }> {
  ...
  public crearServicio(
    ...
    return this.httpCliente.post<Servicio>(
      `${this.urlBaseApi}/negocios/${idNegocio}/servicios`,
      datos,
      { withCredentials: true },
    );
  }
  ...
  public eliminarServicio(idServicio: number): Observable<{ mensaje: string }> {
    return this.httpCliente.delete<{ mensaje: string }>(
      `${this.urlBaseApi}/negocios/servicios/${idServicio}`,
      { withCredentials: true },
    );
  }
  ...
  public crearProducto(
    ...
    return this.httpCliente.post<Producto>(
      `${this.urlBaseApi}/negocios/${idNegocio}/productos`,
      datos,
      { withCredentials: true },
    );
  }
  ...
  public eliminarProducto(idProducto: number): Observable<{ mensaje: string }> {
    return this.httpCliente.delete<{ mensaje: string }>(
      `${this.urlBaseApi}/negocios/productos/${idProducto}`,
      { withCredentials: true },
    );
  }
  ...
  public subirImagen(idNegocio: number, archivo: File): Observable<ImagenNegocio> {
    ...
    return this.httpCliente.post<ImagenNegocio>(
      `${this.urlBaseApi}/negocios/${idNegocio}/imagenes`,
      formData,
      { withCredentials: true },
    );
  }
  ...
  public eliminarImagen(idImagen: number): Observable<{ mensaje: string }> {
    return this.httpCliente.delete<{ mensaje: string }>(
      `${this.urlBaseApi}/negocios/imagenes/${idImagen}`,
      { withCredentials: true },
    );
  }
}
